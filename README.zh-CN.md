<div align="center">
  ...
  <p>
    <img alt="版本" src="https://img.shields.io/badge/version-0.1.5-6d28d9" />
...
- **丰富的 Markdown 渲染**：支持标题、列表、任务列表、表格、引用、提示块、图片、代码高亮、KaTeX 公式、Mermaid 架构图、ECharts 交互图表、脚注、Emoji 和行内样式。
...
<table>
  ...
  <tr>
    ...
    <td><img src="imgs/ZH/markcard-page-12.webp" alt="MarkCard 案例第 12 页" /></td>
  </tr>
  <tr>
   <td><img src="imgs/ZH/markcard-page-13.webp" alt="MarkCard 案例第 13 页" /></td>
   <td></td>
   <td></td>
  </tr>
</table>
...
| 富内容 | Highlight.js、KaTeX、Mermaid、ECharts |
...
- **柱状图 (`bar`)**：数值对比、多组分类对比、水平条形排行榜。
- **折线图 (`line`)**：时序趋势、平滑折线走势、面积占比图。
- **饼图 / 环形图 (`pie`)**：渠道来源统计、比例分布（内置外部标签防溢出和对称居中保护）。
- **雷达图、热力图等**：支持所有标准直角坐标系与极坐标系 ECharts 图表。

> 💡 **工具栏快捷插入**：点击 Markdown 编辑器工具栏第二行的 **📊 插入图表** 按钮，即可在下拉菜单中直接选择柱状图、折线图或饼图模板一键插入，开箱即用。
